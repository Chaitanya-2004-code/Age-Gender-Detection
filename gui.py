...
# from keras.models import load_model
# from keras.losses import mean_absolute_error  # Import custom loss/metric if required

# model = load_model('Age_Sex_Detection.h5', custom_objects={'mae': mean_absolute_error})
